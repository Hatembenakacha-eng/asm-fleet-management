...
import { InjectionToken, InputSignal, InputSignalWithTransform, OutputEmitterRef, WritableSignal, Signal, OnDestroy, ComponentRef, Provider, EnvironmentProviders, ElementRef } from '@angular/core';
import { SmoothScrollManager, SmoothScrollToOptions, SmoothScrollElement, SmoothScrollToElementOptions } from 'ngx-scrollbar/smooth-scroll';
...
declare enum ScrollbarUpdateReason {
    AfterInit = "AfterInit",
    Resized = "ResizeObserver"
}
declare const NG_SCROLLBAR_OPTIONS: InjectionToken<NgScrollbarOptions>;
declare const NG_SCROLLBAR_POLYFILL: InjectionToken<string>;
interface NgScrollbarOptions {
    /**
...
type ScrollbarDragging = 'x' | 'y';

declare class ScrollbarInputOutputs {
    /** Global options */
    ...
    /** Show scrollbar buttons */
    withButtons: InputSignalWithTransform<boolean, string | boolean>;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<ScrollbarInputOutputs, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<ScrollbarInputOutputs, never, never, { "orientation": { "alias": "orientation"; "required": false; "isSignal": true; }; "visibility": { "alias": "visibility"; "required": false; "isSignal": true; }; "withButtons": { "alias": "withButtons"; "required": false; "isSignal": true; }; "disableInteraction": { "alias": "disableInteraction"; "required": false; "isSignal": true; }; "disableSensor": { "alias": "disableSensor"; "required": false; "isSignal": true; }; "sensorThrottleTime": { "alias": "sensorThrottleTime"; "required": false; "isSignal": true; }; "hoverOffset": { "alias": "hoverOffset"; "required": false; "isSignal": true; }; "trackScrollDuration": { "alias": "trackScrollDuration"; "required": false; "isSignal": true; }; "appearance": { "alias": "appearance"; "required": false; "isSignal": true; }; "position": { "alias": "position"; "required": false; "isSignal": true; }; "trackClass": { "alias": "trackClass"; "required": false; "isSignal": true; }; "thumbClass": { "alias": "thumbClass"; "required": false; "isSignal": true; }; "buttonClass": { "alias": "buttonClass"; "required": false; "isSignal": true; }; }, { "afterInit": "afterInit"; "afterUpdate": "afterUpdate"; }, never, never, true, never>;
}
 ...
 */
declare class ViewportAdapter extends ScrollbarInputOutputs {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ViewportAdapter, never, never, {}, {}, never, never, true, never>;
}

declare class ScrollContent {
    static ɵfac: i0.ɵɵFactoryDeclaration<ScrollContent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<ScrollContent, "ng-scroll-content", never, {}, {}, never, ["*"], true, never>;
}

declare class Scrollbars {
    adapter: ViewportAdapter;
    static ɵfac: i0.ɵɵFactoryDeclaration<Scrollbars, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<Scrollbars, "scrollbars", never, {}, {}, never, never, true, never>;
}

declare class ScrollViewport extends NgScrollbarCore implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ScrollViewport, "ng-scroll-viewport", never, { "contentWrapperElement": { "alias": "contentWrapperElement"; "required": false; }; "spacerElement": { "alias": "spacerElement"; "required": false; }; }, {}, never, ["*"], true, never>;
}

declare class NgScrollbarCore {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgScrollbarCore, never, never, {}, {}, never, never, true, never>;
}

declare class NgScrollbar extends NgScrollbarCore {
    private contentWrapper;
    contentWrapperElement: Signal<HTMLElement>;
    constructor();
    /**
     * Smooth scroll functions
     */
...
declare class NgScrollbarExt implements OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgScrollbarExt, "ng-scrollbar[externalViewport]", ["ngScrollbar"], { "externalViewport": { "alias": "externalViewport"; "required": true; "isSignal": true; }; "externalContentWrapper": { "alias": "externalContentWrapper"; "required": false; "isSignal": true; }; "externalSpacer": { "alias": "externalSpacer"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, [{ directive: typeof ViewportAdapter; inputs: { "position": "position"; "withButtons": "withButtons"; "appearance": "appearance"; "thumbClass": "thumbClass"; "trackClass": "trackClass"; "buttonClass": "buttonClass"; "visibility": "visibility"; "hoverOffset": "hoverOffset"; "orientation": "orientation"; "disableSensor": "disableSensor"; "sensorThrottleTime": "sensorThrottleTime"; "disableInteraction": "disableInteraction"; "trackScrollDuration": "trackScrollDuration"; }; outputs: { "afterInit": "afterInit"; "afterUpdate": "afterUpdate"; }; }]>;
}

type AsyncViewportOption = '' | 'auto';
declare class NgScrollbarAsyncViewport {
    private readonly scrollbar;
    private readonly contentObserver;
    asyncViewport: InputSignal<AsyncViewportOption>;
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<NgScrollbarAsyncViewport, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgScrollbarAsyncViewport, "ng-scrollbar[externalViewport][asyncViewport]", never, { "asyncViewport": { "alias": "asyncViewport"; "required": true; "isSignal": true; }; }, {}, never, never, true, never>;
}

declare class NgSyncSpacer {
    private readonly sharedResizeObserver;
    private readonly scrollbar;
    ...
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<NgSyncSpacer, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgSyncSpacer, "ng-scrollbar[externalViewport][syncSpacer]", never, {}, {}, never, never, true, never>;
}

declare class NgScrollbarModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<NgScrollbarModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<NgScrollbarModule, never, [typeof NgScrollbar, typeof NgScrollbarExt, typeof NgScrollbarAsyncViewport, typeof NgSyncSpacer], [typeof NgScrollbar, typeof NgScrollbarExt, typeof NgScrollbarAsyncViewport, typeof NgSyncSpacer]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<NgScrollbarModule>;
}
declare function provideScrollbarOptions(options: NgScrollbarOptions): Provider[];
declare function provideScrollbarPolyfill(url: string): EnvironmentProviders;
 ...
 */
interface NgScrollbarRef<T> {
    componentRef: ComponentRef<T>;
    destroy: () => void;
}
declare class NgScrollbarAnywhere {
     ...
     */
    private createScrollbarComponent;
    /**
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<NgScrollbarAnywhere, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NgScrollbarAnywhere>;
}

declare class NgScrollbarDocument {
    private readonly document;
    private readonly injector;
    private readonly appRef;
    attachScrollbar(options?: NgScrollbarOptions): ComponentRef<ScrollViewport>;
    static ɵfac: i0.ɵɵFactoryDeclaration<NgScrollbarDocument, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<NgScrollbarDocument>;
}
...
export type { NgScrollbarOptions, NgScrollbarRef, ScrollbarAppearance, ScrollbarOrientation, ScrollbarPosition, ScrollbarVisibility };
